...
/* harmony import */ var _modules_scripts_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/scripts.js */ "./js/modules/scripts.js");
...
window.addEventListener('DOMContentLoaded', function () {
  // Utils
  // ---------------------------------
  Object(_modules_scripts_js__WEBPACK_IMPORTED_MODULE_3__["useAboutAccordion"])();
  Object(_modules_scripts_js__WEBPACK_IMPORTED_MODULE_3__["useFooterAccordion"])();
  Object(_modules_scripts_js__WEBPACK_IMPORTED_MODULE_3__["changeTitleText"])();
  Object(_modules_scripts_js__WEBPACK_IMPORTED_MODULE_3__["changeArticleText"])();
...
/*!*******************************!*\
  !*** ./js/modules/scripts.js ***!
  \*******************************/
/*! exports provided: useFooterAccordion, useAboutAccordion, changeTitleText, changeArticleText */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "useFooterAccordion", function() { return useFooterAccordion; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "useAboutAccordion", function() { return useAboutAccordion; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "changeTitleText", function() { return changeTitleText; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "changeArticleText", function() { return changeArticleText; });
function useFooterAccordion() {
  var btn = 'button[data-open-icon="plus"]';
  var part = document.querySelector('.part-wrapper');
  var ofice = document.querySelector('.our-ofice');
  if (part) {
  ...
  if (ofice) {
    ofice.addEventListener('click', function (evt) {
      if (evt.target.closest(btn)) {
...
function useAboutAccordion() {
  var btn = document.querySelector('button[data-about-open=""]');
  var list = document.querySelector('.about__description');
  if (btn) {
...
function changeTitleText() {
  ...
  if (goods) {
    var title = goods.querySelector('h2');
    var newText = goods.querySelector('span');
...
function changeArticleText() {
  ...
  if (article) {
    var textLink = article.querySelector('a');
    var newText = article.querySelector('span');
    if (innerWidth <= breakPoint) {
